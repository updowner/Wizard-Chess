...
I think this problem can be solved by replacing the magnet sensor(reed switch) with hall effect sensor this sensor has better sensivty but solve it by puting 8X8 LED MAX7219 DOT MATRIX DISPLAY to show the pieces localization so you can know if the piece was recognized or not
